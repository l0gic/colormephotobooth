    ...
    <>
      <main className="min-h-screen">
        ...
        <footer id="contact" className="bg-white pt-20 pb-10 relative overflow-hidden border-t border-gray-200">
          {/* Footer decorations */}
          <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500"></div>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 mb-20">
              <div>
                <h2 className="text-4xl font-bold mb-6 uppercase tracking-tighter leading-none text-gray-900">
                  Let&apos;s Elevate Your <br /><span className="gradient-text">Corporate Event.</span>
                </h2>
                <p className="text-gray-700 mb-8 font-medium">
                  Transform your company gatherings into memorable experiences. We are currently accepting corporate event bookings for 2026-2027.
                </p>
            ...
            <div className="border-t border-gray-200 pt-10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600 uppercase tracking-widest">
              ...
              <div className="flex gap-8">
                <a href="#" className="hover:text-blue-600 transition font-medium">Privacy Policy</a>
                <a href="#" className="hover:text-blue-600 transition font-medium">Terms of Service</a>
              </div>
            </div>
          </div>
        </footer>
      </main>
      <ChatWidget eventType="corporate" />
    </>
  );
}
